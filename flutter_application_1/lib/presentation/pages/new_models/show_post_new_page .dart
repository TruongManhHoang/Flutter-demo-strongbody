...
class ShowPostNewPage extends StatefulWidget {
  const ShowPostNewPage({super.key});

  @override
  State<ShowPostNewPage> createState() => _PostNewPageState();
}

class _PostNewPageState extends State<ShowPostNewPage> {
